import { guestDisplayNameForPeerId } from './participantsMapper';
 ...
 */
export function resolvePeerDisplayNameForUi(peerId, participants, opts) {
 ...
 */
export function buildDisplayNameUiMap(participants, opts) {
    const out = new Map();
