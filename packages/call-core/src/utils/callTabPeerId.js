 ...
 */
export function readOrCreateCallDeviceId() {
 ...
 */
function shouldReusePersistedTabPeerId() {
 ...
 */
export function newCallTabPeerId() {
...
export function resetCallTabPeerId() {
    if (typeof sessionStorage !== 'undefined') {
        try {
            sessionStorage.removeItem(SS_CALL_TAB_PEER_ID);
        }
