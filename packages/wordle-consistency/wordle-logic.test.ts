/**
 * Ground-truth tests: client vs server Wordle helpers must agree.
 * Run: npm run test:wordle (from repo root)
 */
import { describe, expect, it } from 'vitest'
import { computeFeedback as coreComputeFeedback, wordGraphemeCount as coreWordGraphemeCount } from 'wordle-core'
import {
  computeFeedback as clientComputeFeedback,
  normalizeWord as clientNormalizeWord,
  wordGraphemeCount as clientWordGraphemeCount,
} from '../../apps/client/src/wordle/wordleLogic.ts'
import {
  computeFeedback as serverComputeFeedback,
  normalizeWord as serverNormalizeWord,
  wordGraphemeCount as serverWordGraphemeCount,
} from '../../apps/server/src/wordle/wordleLogic.ts'
...
describe('computeFeedback (client vs server)', () => {
  ...
  it('throws on length mismatch (client and server use wordle-core)', () => {
...
describe('computeFeedback (re-exported from wordle-core)', () => {
  it('client and server use the same implementation as wordle-core', () => {
...
describe('wordGraphemeCount (client, server, wordle-core)', () => {
