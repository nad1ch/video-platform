...
type FinalizedReason = 'empty_grace_elapsed' | 'forced' | 'lru_eviction' | 'idle_reap'
...
export interface BuildGameSessionReportOptions {
  ...
  finalizedAt?: Date
  finalizedReason?: 'empty_grace_elapsed' | 'forced' | 'lru_eviction' | 'idle_reap'
}
