 ...
 *
 * Регенерація: npm run gen:wordle-dict
 */
...
function ensureFreq() {
  ...
  throw new Error(
    `Missing ${freqPath}. Add uk_opensubtitles_50k.txt (see src/wordle/dictionary/SOURCES.md) or download HermitDave FrequencyWords content/2016/uk/uk_50k.txt`,
  )
}
