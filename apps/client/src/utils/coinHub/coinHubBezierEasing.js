...
export function spinCubicBezierProgress(u) {
...
export function slotCubicBezierProgress(u) {
...
export function dailySpinReelProgress(u) {
    return dailySpinYForTime(Math.min(1, Math.max(0, u)));
}
export function dailySpinPhaseTimeRemap(u) {
