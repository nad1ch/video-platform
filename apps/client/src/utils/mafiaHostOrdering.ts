...
export function pinHostPeerToEndOfOrder(order: string[], hostPeerId: string | null): string[] {
...
export function mafiaNightActionMaxSeatForOrder(order: string[], hostPeerId: string | null): number {
  const hp = typeof hostPeerId === 'string' ? hostPeerId.trim() : ''
