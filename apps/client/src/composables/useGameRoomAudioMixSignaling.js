...
function parseGameRoomAudioMixUpdate(data) {
...
export function useGameRoomAudioMixSignaling(deps) {
    const { sendSignalingMessage, subscribeSignalingMessage, wsStatus, isGameRoomRoute, isViewMode, isGameRoomHost, hostPeerId, setRemoteListenVolume, setRemoteListenMuted, } = deps;
    ...
    watch([isViewMode, isGameRoomRoute, hostPeerId], ([viewMode, inRoom, hpid]) => {
        if (!inRoom || !viewMode) {
    ...
    function broadcastGameRoomAudioMixDelta(delta) {
