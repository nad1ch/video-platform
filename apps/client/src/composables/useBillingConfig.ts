...
import { fetchBillingConfig, type BillingConfigDto } from '@/services/billingApi'
...
const config = ref<BillingConfigDto | null>(null)
...
export function refreshBillingConfig(): Promise<void> {
