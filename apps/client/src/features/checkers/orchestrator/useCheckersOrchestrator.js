...
import { createInitialCheckersState, getLegalMoves, getValidMove, isSameCheckersPosition, } from '../core/checkersEngine';
import { createCheckersWsClient, } from '../ws/checkersWs';
...
export function useCheckersOrchestrator(options) {
    ...
    function selectOwnPiece(pos, current) {
    ...
    function isValidDestination(pos) {
    ...
    watch(() => options.displayName?.value ?? '', (displayName) => {
