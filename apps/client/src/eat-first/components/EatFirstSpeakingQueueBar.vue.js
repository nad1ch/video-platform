...
const props = withDefaults(defineProps(), { showTools: false });
const { t } = useI18n();
...
const labels = computed(() => ({
    ...
    chipRemoveTitle: (by, target) => t('eatFirstCall.speakingQueueRemoveTitle', { by, target }),
    chipViewOnlyTitle: (by, target) => t('eatFirstCall.speakingQueueChipViewOnly', { by, target }),
}));
...
const __VLS_defaults = { showTools: false };
const __VLS_ctx = {
    ...{},
    ...{},
    ...{},
...
const __VLS_1 = __VLS_asFunctionalComponent1(__VLS_0, new __VLS_0({
    ...
    speakingActive: (__VLS_ctx.speakingMode),
...
var __VLS_4;
// @ts-ignore
[segments, speakingMode, showTools, labels, onToggleSpeakingMode, onRemovePair, onClearAll,];
